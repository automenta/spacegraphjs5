...
A live demo showcasing various features is available on GitHub
Pages: [https://TTime.github.io/spacegraphjs/](https://TTime.github.io/spacegraphjs/)
...
1. **HTML Setup**:
   ...
   _Note: For HTML nodes and default UI elements like context menus, you might need additional CSS. Refer to the
   library's CSS or provide your own._
...
For detailed API documentation, including all classes, methods, options, and plugin development, please
visit [our documentation site](PLACEHOLDER_API_DOCS_LINK). (Link to be updated once JSDoc/TypeDoc is hosted).
...
Contributions are welcome! Please read our `CONTRIBUTING.md` (to be created) for guidelines on how to contribute, report
