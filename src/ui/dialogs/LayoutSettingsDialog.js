...
export class LayoutSettingsDialog {
    ...
    _createDialogElement() {
        ...
        $('#apply-layout-button', this.layoutSettingsDialogElement)?.addEventListener(
            'click',
            this._onApplyLayout
        );
        $('#close-layout-dialog', this.layoutSettingsDialogElement)?.addEventListener(
            'click',
            this.hide
        );
    }
    ...
    dispose() {
        if (this.layoutSettingsDialogElement) {
            ...
            $('#close-layout-dialog', this.layoutSettingsDialogElement)?.removeEventListener(
                'click',
                this.hide
            );
            $('#layout-select', this.layoutSettingsDialogElement)?.removeEventListener(
                'change',
                this._onLayoutSelectionChange
            );
