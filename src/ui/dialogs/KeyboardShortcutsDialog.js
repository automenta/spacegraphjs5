...
export class KeyboardShortcutsDialog {
    constructor(space) {
        ...
        this.keyboardShortcuts = [
            ...
            {
                keys: ['Escape'],
                description: 'Close menus, cancel linking, deselect all, or exit pointer lock',
            },
    ...
    _createDialogElement() {
        ...
        $('#close-shortcuts-dialog', this.keyboardShortcutsDialogElement)?.addEventListener(
            'click',
            this.hide
        );
    }
    ...
    dispose() {
        if (this.keyboardShortcutsDialogElement) {
            $('#close-shortcuts-dialog', this.keyboardShortcutsDialogElement)?.removeEventListener(
                'click',
                this.hide
            );
