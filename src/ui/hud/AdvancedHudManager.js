...
export class AdvancedHudManager extends HudManager {
    ...
    _setupMenuBar() {
        ...
        if (this.hudRegionTop) {
            // Assuming hudRegionTop is created by base or here
    ...
    _createAdvancedHudElements() {
        ...
        if (!this.notificationContainer.parentNode) {
            ...
            (this.hudTopCenterGroup || this.hudRegionTop || this.hudLayer).appendChild(
    ...
    _updateNodeCountStatus() {
        ...
        const count =
            nodePlugin && typeof nodePlugin.getNodes === 'function' ? nodePlugin.getNodes().size : 0;
    ...
    _populateDefaultMenus() {
        ...
        fileMenu.addMenuItem('exportGraph', 'Export Graph...', () => this._exportGraph(), {
            hotkey: 'Ctrl+E',
        });
        ...
        fileMenu.addSeparator();
        fileMenu.addMenuItem('toggleFullscreen', 'Toggle Fullscreen', () => this._toggleFullscreen(), {
            hotkey: 'F11',
        });
