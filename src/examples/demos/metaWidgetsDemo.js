...
export function createGraph(space) {
    ...
    const controlCenter = WidgetComposer.createControlCenter(space, {x: -600, y: 150, z: 0}, [
        {
            name: 'power',
            title: 'Power System',
            enabled: true,
    ...
    const monitorDash = WidgetComposer.createMonitoringDashboard(space, {x: 600, y: 150, z: 0}, [
    ...
    // Workflow Builder
    const workflowBuilder = WidgetComposer.createWorkflowBuilder(space, {x: 300, y: -200, z: 0}, [
