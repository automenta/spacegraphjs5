...
await space.init();`,
    ...
    _documentClass(name, instance, metadata = {}) {
        ...
        // Analyze properties
        const properties = Object.getOwnPropertyNames(instance).filter(
            prop => !prop.startsWith('_') && typeof instance[prop] !== 'function'
        );
    ...
    _generateOverview() {
        return {
            ...
            description:
                'A comprehensive 3D graph visualization library with fractal zooming capabilities',
