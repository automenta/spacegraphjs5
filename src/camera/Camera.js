...
export class Camera {
    ...
    moveTo(x, y, z, duration = 0.7, lookAtTarget = null, newCameraMode = null) {
        ...
        const targetLook =
            lookAtTarget instanceof THREE.Vector3 ? lookAtTarget.clone() : new THREE.Vector3(x, y, 0);
    ...
    startOrbitDrag(startX, startY) {
        if (this.cameraMode !== CAMERA_MODES.DRAG_ORBIT || this.isOrbitDragging || this.isPanning)
            return;
        this._isManuallyControlled = true;
