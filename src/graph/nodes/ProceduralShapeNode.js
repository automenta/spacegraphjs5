...
export class ProceduralShapeNode extends ShapeNode {
    ...
    _generateOrganic() {
        ...
        for (let i = 0; i < positions.length; i += 3) {
            ...
            // Add bulges
            const bulgeNoise =
                Math.sin(vertex.x * bulges) * Math.sin(vertex.y * bulges) * Math.sin(vertex.z * bulges);
    ...
    _generateFlower() {
        ...
        for (let layer = 0; layer < layers; layer++) {
            ...
            for (let i = 0; i < petals; i++) {
                ...
                const petalGeometry = new THREE.ConeGeometry(layerRadius * 0.3, layerRadius, 8);
    ...
    _generateTree() {
        ...
        const createBranch = (startPos, direction, length, currentDepth) => {
            ...
            const branchGeometry = new THREE.CylinderGeometry(thickness * 0.5, thickness, length, 8);
